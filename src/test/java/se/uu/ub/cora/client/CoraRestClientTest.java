...
public class CoraRestClientTest {
	...
	public void setUp() {
		...
		coraClient = new CoraRestClientImp(httpHandlerFactorySpy, baseUrl, authToken);
	}
	...
	//
	// @Test
	// public void testReadRecordListDataForFactoryIsOk() throws
	...
	//
	// @Test
	// public void testReadRecordListNoFilterOk() throws
	// UnsupportedEncodingException {
	// assertEquals(fixture.testReadRecordList(), "Everything ok");
	// }
	//
	// @Test
	// public void testReadRecordListWithAddedFilterOk() throws
	// UnsupportedEncodingException {
	// fixture.setType("someType");
	// fixture.setAuthToken("someToken");
	// String json =
	// "{\"name\":\"filter\",\"children\":[{\"name\":\"part\",\"children\":[{\"name\":\"key\",\"value\":\"idFromLogin\"},{\"name\":\"value\",\"value\":\"someId\"}],\"repeatId\":\"0\"}]}";
	//
	...
	//
	// @Test
	// public void testUploadDataForFactoryIsOk() throws ClientProtocolException,
	// IOException {
	// fixture.setType("someType");
	// fixture.setId("someId");
	// fixture.setAuthToken("someToken");
	...
	// fixture.testUpload();
	//
	// HttpMultiPartUploaderSpy httpHandlerSpy =
	// httpHandlerFactorySpy.httpMultiPartUploaderSpy;
	// assertEquals(httpHandlerSpy.headerFields.get("Accept"),
	// "application/vnd.uub.record+json");
	...
	//
	// String json =
	// "{\"name\":\"search\",\"children\":[{\"name\":\"include\",\"children\":["
	// +
